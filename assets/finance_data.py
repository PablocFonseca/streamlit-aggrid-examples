"""
Financial portfolio data for AG Grid demos
Source: https://github.com/ag-grid/ag-grid-demos/blob/main/finance/typescript/src/data.ts

Contains 134 financial instruments:
- 79 Stocks
- 20 Bonds
- 27 ETFs
- 8 Cryptocurrencies
...
- instrument: Type (Stock, Bond, ETF, Crypto)
- quantity: Number of units held
- purchaseDate: Date of purchase
- purchasePrice: Original purchase price
- price: Current market price
- timeline: Array of 24 historical price points
"""

import pandas as pd

# Complete dataset with all 134 financial instruments
...
def get_financial_data():
    """
    Returns a DataFrame containing all 134 financial instruments

    Returns:
        pd.DataFrame: DataFrame with columns for ticker, name, instrument,
                     quantity, purchaseDate, purchasePrice, price, and timeline
    """
    return pd.DataFrame(FINANCIAL_INSTRUMENTS)
