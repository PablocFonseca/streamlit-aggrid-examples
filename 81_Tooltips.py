...
columnDefs = [
    ...
    },
    {
        ...
        "tooltipValueGetter": JsCode(
            """function(){return "Create any fixed message, e.g. This is the Athlete's Age"}"""
        ),
    ...
    },
    {
        "field": "year",
        "tooltipValueGetter": JsCode(
            """function(p) {return "This is a dynamic tooltip using the value of " + p.value}"""
        ),
        ...
        "children": [
            {
                "field": "sport",
                "tooltipValueGetter": JsCode(
                    """function(){return "Tooltip text about Sport should go here"}"""
                ),
